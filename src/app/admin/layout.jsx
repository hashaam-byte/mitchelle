...
export default function AdminLayout({ children }) {
  ...
  const [userRole, setUserRole] = useState('ADMIN'); // or 'SUPER_ADMIN'
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-pink-50">
      ...
      <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-80 lg:flex-col z-50">
        <div className="flex flex-col flex-grow overflow-y-auto backdrop-blur-2xl bg-gradient-to-br from-white/90 via-pink-50/70 to-purple-50/70 border-r border-white/50 shadow-2xl">
          ...
          {/* Quick Actions */}
          <div className="mx-4 mb-4 p-4 bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-500 rounded-2xl text-white relative overflow-hidden shadow-xl">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-2">
                <button className="w-full bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white text-sm font-medium py-2.5 rounded-xl transition-all duration-300 hover:scale-105">
                  Add New Product
                </button>
                <button className="w-full bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white text-sm font-medium py-2.5 rounded-xl transition-all duration-300 hover:scale-105">
                  Create Discount
      ...
      >
        ...
        ></div>
<div
          className={`absolute top-0 left-0 bottom-0 w-80 max-w-[85vw] backdrop-blur-2xl bg-gradient-to-br from-white/95 via-pink-50/90 to-purple-50/90 shadow-2xl transition-transform duration-300 ${
            ...
            <div className="relative px-6 py-6 border-b border-white/40 overflow-hidden">
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <div className="absolute inset-0 bg-gradient-to-br from-pink-500 to-purple-600 rounded-2xl blur-xl opacity-50 animate-pulse"></div>
                    <div className="relative w-12 h-12 bg-gradient-to-br from-pink-500 via-purple-600 to-pink-600 rounded-2xl flex items-center justify-center shadow-xl">
                      <Sparkles className="w-6 h-6 text-white" />
                    </div>
                  </div>
                  <div>
